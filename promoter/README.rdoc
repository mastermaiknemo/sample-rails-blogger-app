...
This is a leightweight rails app with some react.js demonstration code and funky code snippets.
Be like a rainbow.
...
update database.yml to your local machine (its sqlite3 here)
